...
//                 {/* Scrollable Content Area */}
//                 <div className="flex-1 overflow-y-auto p-5 scrollbar-thin scrollbar-thumb-emerald-300 scrollbar-track-emerald-50">
//                     {/* Invoice Content for Printing (Hidden) */}
//                     <div ref={invoiceRef} className="hidden">
//                         <div className="invoice-container">
//                             <div className="header">
//                                 <div className="receipt-title">PAYMENT RECEIPT</div>
...
//                                 <span className="value">{paymentInfo.customerDetails.name}</span>
//                             </div>
//                             <div className="info-row">
//                                 <span className="label">Email:</span>
//                                 <span className="value">{paymentInfo.customerDetails.email}</span>
//                             </div>
//                             <div className="info-row">
//                                 <span className="label">Phone:</span>
//                                 <span className="value">{paymentInfo.customerDetails.phone}</span>
//                             </div>
...
//                                 <span className="value">Customer Payment</span>
//                             </div>

//                             <div className="signature-area">
//                                 <div className="info-row">
//                                     <span className="label">Customer Signature:</span>
//                                     <span className="value">_____________________</span>
//                                 </div>
//                                 <div className="info-row">
