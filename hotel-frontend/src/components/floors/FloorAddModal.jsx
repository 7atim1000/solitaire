...
const FloorAddModal = ({ setIsAddFloorModal }) => {
    ...
    const FloorMutation = useMutation({
        mutationFn: (reqData) => addFloor(reqData),
        onSuccess: (res) => {
        ...
        style={{ backgroundColor: 'rgba(5, 24, 1, 0.4)' }}>
            ...
            >
                ...
                <div className="sticky top-0 bg-white z-10 flex items-center justify-between p-6 border-b">
                     <h2 className="text-xl font-semibold text-gray-800">Add New Floor</h2>
                     <button
                         onClick={handleClose}
