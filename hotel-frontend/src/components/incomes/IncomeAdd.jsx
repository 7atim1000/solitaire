        ...
        <div className='fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
            ...
            >
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className='text-emerald-100 text-xs sm:text-sm'>Create new income account</p>
                            </div>
                        </div>
                        <button 
                            onClick={handleClose}
                ...
                <div className="border-t border-emerald-200 bg-emerald-50 p-4">
                    <div className="flex items-center gap-3">
                        <MdAccountBalance className="text-emerald-600 w-5 h-5" />
                        <div>
                            <p className="text-sm font-medium text-emerald-800">Income Categories</p>
