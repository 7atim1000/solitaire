                            ...
                            <tbody>
                                {list.length === 0
                                    ...
                                    : list.map((customer, index) => (
                                        ...
                                        >
                                            <td className='p-4 font-medium text-emerald-900 text-xs'>{customer.customerName}</td>
                                            ...
                                            <td className='p-4 text-emerald-700 text-xs'>
                                                {customer.company && customer.company.companyName ? customer.company.companyName : '-'}
                                            </td>
                                            <td className='p-4'>
                                                <div className="flex gap-2">
                                                    ...
                                                    {!customer.companies && !customer.personal && (
                                            ...
                                            <td className='p-4'>
                                                <div className='flex items-center gap-2'>
                                                    ...
                                                    {/* Payment button - Show only for personal customers (companies === false) */}
                                                    {!customer.companies && (
                            ...
                            <tfoot className='bg-gradient-to-r from-emerald-500 to-emerald-600 text-white'>
                                <tr>
                                    <td className="p-4 font-bold">
                                        {list.length}
                                        <span className='font-normal opacity-90 ml-1'>guests</span>
                                    </td>
...
//                                             <td className='p-4 text-emerald-700'>{customer.company.companyName}</td>
