                ...
                <div className="bg-white rounded-2xl shadow-xl mb-2 md:mb-2 p-4 md:p-2">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                        <div className="flex items-center gap-3">
                            <BackButton />
                            <div>
                                <h1 className="text-xl md:text-xl font-bold text-emerald-800 tracking-tight">
                                    Booking Invoice
                                </h1>
                        ...
                        <div className="p-2 md:p-1">
                            <div className="relative overflow-hidden rounded-xl border-2 border-emerald-100">
                                <img
                                    ...
                                    alt="Room"
                                    className="w-full h-48 md:h-55 object-cover transform hover:scale-105 transition-transform duration-500"
                                />
...
//             toast.warning('please specified booking date!');
//             return;
//         };
//         if (!roomData.roomNo) {
//             toast.warning('Please select room first!');
...
//             const id = roomData._id;
//             const name = roomData.roomNo;
//             const pricePerQuantity = roomData.price;
//             const seats = roomData.seats;
//             const dateBooking = formData.bookingDate;  const dateReturn = formData.returnDate
//             // new Date()
//             const newObj = { id: id, name,  pricePerQuantity , quantity: dayCount, qty: dayCount, price: pricePerQuantity * dayCount ,
//                 dateBooking, dateReturn, bookingDays : dayCount, seats: seats 
//              };
...
//     const roomNo = roomData.roomNo; const id = roomData._id; const name = roomData.name ; const price = roomData.price ;
//     const seats = roomData.seats; const floor = roomData.floor;
...
//                         <BackButton />
//                         <h1 className='text-[#1a1a1a] text-lg font-bold tracking-wider '>Booking Invoice</h1>
//                     </div>

//                     <div className='flex items-center justify-content shadow-xl/30 px-1 h-12 rounded-sm border-b-2 border-emerald-600'>
...
//                                             <IoMdArrowDropright className='inline mt-4 text-emerald-600' size={20} />
//                                         </button>
//                                     );
//                                 })}
//                             </div>
...
//                             <div className='flex items-center gap-3'>
//                                 <FaCircleUser className='h-6 w-6 text-emerald-600' />
...
//                                     </p>
//                                     <p className='text-xs font-normal text-emerald-600'>
//                                         {customerData.Idnumber || 'ID Number'}
//                                     </p>
//                                 </div>
...
//                                 <p className={`${customerData.balance === 0.00 ? 'text-emerald-600' : 'text-[#be3e3f]'} text-sm font-medium`}>
...
//                             <h1 className ='text-emerald-600 text-lg font-bold flex justify-center underline'>{roomData.roomNo}</h1>
//                         </div>
//                         <div className='shadow-xl mt-1 flex justify-center'>
//                             <div className='w-[70%] h-70 rounded-sm overflow-hidden border-b-3 border-emerald-600 p-2'> {/* Square container with circular mask */}
//                                 <img
...
//                                 <span className ='text-emerald-600 text-sm font-bold'>FOR</span> 
//                                 <span className ='text-[#1a1a1a] text-xl font-bold mx-3'>{roomData.seats}</span>
//                                 <span className ='text-sm text-emerald-600 font-bold'>Persons</span>
//                             </h1>
//                         </div>

//                         <div className ='shadow-xl flex items-center justify-between p-2'>
//                             <div className ='shadow-lg/30 p-1 px-5 rounded-md border-b border-emerald-600'>
//                             <p className ='text-[#1a1a1a] text-md font-bold flex justify-center'>{roomData.floor}</p>
//                             </div>
                           
//                             <div className='shadow-lg/30 p-1 px-5  rounded-md border-b border-emerald-600 flex items-center gap-2'>
//                                 <p className='text-[#1a1a1a] text-lg font-bold flex justify-center'>{roomData.price}</p>
//                                 <span className ='text-sm text-emerald-600 font-normal'>AED / night</span>
//                             </div>
//                         </div>
...
//                                 <label className='text-emerald-600 block mb-2 mt-3 text-sm font-medium'>From :</label>
...
//                                         value={formData.bookingDate}
//                                         onChange={handleDateChange}
//                                         className='cursor-pointer bg-transparent flex-1 text-[#1a1a1a] focus:outline-none border-b border-emerald-600 w-full'
//                                         required
//                                         autoComplete='none'
//                                     />
//                                 </div>
//                             </div>
//                             <div className='flex items-center justify-between'>
//                                 <label className='text-emerald-600 block mb-2 mt-3 text-sm font-medium'>To :</label>
//                                 <div className='flex items-center p-2 px-4 text-xs font-normal '>
//                                     <input
//                                         type='date'
//                                         name='returnDate'
...
//                                         value={formData.dayCount}
//                                         readOnly
//                                         className='cursor-pointer bg-transparent flex-1 text-[#1a1a1a] focus:outline-none border-b border-emerald-600 w-[50%]'
//                                         required
//                                         autoComplete='none'
//                                     />
//                                 </div>
...
//                             <div className=''>
//                                 <button  onClick={() => handleAddToCard({ id, name, seats, price, floor })}
//                                     className='cursor-pointer mt-0'>
//                                     <HiMiniKey className='text-emerald-600 border-b-3 border-emerald-600 rounded-full p-1 bg-white flex justify-end items-end shadow-lg/30' size={60} />
//                                 </button>
//                             </div>
